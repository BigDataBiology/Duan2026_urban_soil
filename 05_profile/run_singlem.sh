...
singlem pipe -1 /data/yiqian/soil/pipeline/00_quality_control/00_raw_clean_data/ngs/CPSNJ01/SNJ01_350.fq1.gz -2 /data/yiqian/soil/pipeline/00_quality_control/00_raw_clean_data/ngs/CPSNJ01/SNJ01_350.fq2.gz -p output.profile.tsv --threads 4 --otu-table otutable.tsv --taxonomic-profile-krona krona.html
